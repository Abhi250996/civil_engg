...
class _CreateProjectScreenState extends State<CreateProjectScreen> {
    ...
    if (picked != null) {
      setState(() {
        if (isStart) {
          ...
          completionDateController.text = DateFormat(
            'dd-MM-yyyy',
          ).format(picked);
        }
      });
                ...
                children: [
                  ...
                  _buildGrid(crossAxisCount, [
                    ...
                    _dropdownField(
                      ...
                      projectCategory,
                      Icons.category,
                      ["Building", "Bridge", "Road", "Dam"],
                      (v) => setState(() => projectCategory = v),
                      accentBlue,
                    ),
                    _inputField(
                      locationController,
  ...
  InputDecoration _inputDecoration(String label, IconData icon, Color iColor) {
    return InputDecoration(
      labelText: label,
      prefixIcon: Icon(icon, color: iColor, size: 16),
      filled: true,
