      ...
      child: Column(
        ...
        children: [
          ...
          _row([
            ...
            _cell("Span Length", spanLengthController),
          ]),
          _divider(),

          _row([
            _cell("Pier Spacing", pierSpacingController),
            _cell("Clearance", clearanceController),
          ...
          _row([
            _cell("River Width", riverWidthController),
            _cell("Flood Level", floodLevelController),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _mobileField("Span Length", spanLengthController),
          _mobileField("Pier Spacing", pierSpacingController),
          _mobileField("Clearance", clearanceController),
          ...
          _mobileField("River Width", riverWidthController),
          _mobileField("Flood Level", floodLevelController),
