    ...
    try {
      ...
      switch (type) {
        case "building":
          ...
          height = parse(
            inputData["floorHeight"] ?? inputData["geometry"]?["height"],
          );
          break;
        ...
        case "tunnel":
          ...
          height = parse(inputData["geometry"]?["depth"]);
          break;

        case "tank":
          width = parse(inputData["tank"]?["diameter"]);
          height = parse(inputData["tank"]?["height"]);
          break;

        case "chimney":
          height = parse(inputData["height"]);
          width = parse(inputData["diameter"]);
          break;

        case "thermal_chimney":
          height = parse(inputData["geometry"]?["height"]);
          width = parse(inputData["geometry"]?["diameter"]);
          break;
        ...
        case "warehouse":
          ...
          height = parse(inputData["dimensions"]?["height"]);
          break;
        ...
        case "tower":
        case "telecom":
          height = parse(inputData["tower"]?["height"]);
          break;
